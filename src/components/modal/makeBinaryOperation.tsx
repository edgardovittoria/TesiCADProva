                ...
                <div className="modalContent">
                    ...
                    <Modal.Footer>
                        {spinner
                            ?
                            <button type="button"
                                    className="bg-navbarSecondary hover:bg-navbarPrimary flex flex-row text-white rounded-sm"
                                    disabled>
                            ...
                            :
                            <button className="bg-navbarSecondary hover:bg-navbarPrimary text-white rounded-sm"
                                    onClick={() => {
                                        handleClose()
                                    }}>
                                Proceed
